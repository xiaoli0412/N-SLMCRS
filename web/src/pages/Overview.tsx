      ...
      <div className="grid grid-cols-3 gap-3.5">
        <div className="col-span-2 glass-card p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[13px] font-semibold text-gray-200">请求量与成功率趋势 <span className="text-gray-600 text-[11px] font-normal">/ Traffic</span></div>
        ...
        <div className="glass-card p-5">
          <div className="text-[13px] font-semibold text-gray-200 mb-3">错误分布 <span className="text-gray-600 text-[11px] font-normal">/ Errors</span></div>
          ...
          <div className="mt-4 pt-3 border-t border-white/[0.04] text-[11px] text-gray-600">
