...
#
# 用法：
#   docker build -t ghcr.io/xiaoli0412/n-slmcrs-gateway:latest -t ghcr.io/xiaoli0412/n-slmcrs-gateway:v0.14.0 .
...
# VERSION 通过 --build-arg 注入主版本号，默认 v0.14.0；与前端 package.json 对齐。
