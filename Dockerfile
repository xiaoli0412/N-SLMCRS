...
#
# 用法：
#   docker build -t ghcr.io/xiaoli0412/n-slmcrs-gateway:latest -t ghcr.io/xiaoli0412/n-slmcrs-gateway:v0.8.0 .
...
#   docker build -f Dockerfile.kernel -t ghcr.io/xiaoli0412/n-slmcrs-kernel:latest -t ghcr.io/xiaoli0412/n-slmcrs-kernel:v0.8.0 .
...
# VERSION 通过 --build-arg 注入主版本号，默认 v0.8.0；与前端 package.json 对齐。
